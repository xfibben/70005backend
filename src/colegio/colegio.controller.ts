import { Controller,Post,Delete,Param,Body ,UseGuards, ParseIntPipe,Get, Patch} from '@nestjs/common';
...
export class ColegioController {
    constructor(private colegioService:ColegioService){}
     ...
     @Patch(':id')
     updateColegio(@Param('id',ParseIntPipe) id:number,@Body() data:UpdateColegioDto){
